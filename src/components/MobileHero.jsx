...
export default function MobileHero() {
  ...
  return (
    <div className="grid grid-cols-1 w-full">
     <img src={heroImgUrl} alt="large painting of a lady, people walking by"/>
     <p className="text-[60px] text-[#151515] font-[900] cxHeading leading-none mt-[39px] ml-[14px] mb-[22px]">MODERN <br/> ART GALLERY</p>
     <p className="ml-[18px]">The arts in the collection of the Modern Art <br/>Gallery all started
          from a spark of <br/>inspiration. Will these pieces inspire you? <br/>Visit
          us and find out.</p>
      <img src={arrowRight} alt="click the button" width={22} className="bg-[#d5966c] scale-50 stroke-current justify-self-center"/>
      <div className="flex gap-0 cursor-pointer items-center text-[#ffffff] ml-[18px]" onMouseEnter={hoverOn} onMouseLeave={hoverOff}>
