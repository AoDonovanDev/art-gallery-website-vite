...
export default function Info(){
  return(
    <div className='w-[1439px] min-h-[1200px] mt-[100px]'>
      <div className="grid grid-cols-5 grid-rows-2 gap-[30px] mx-[167px] h-[1000px]">
        <div className='flex flex-col w-[309px] text-left font-light place-items-start col-span-2 justify-self-start mb-[22px] gap-[50px] pt-[100px]'>
        ...
        <div className='col-span-3 place-self-end max-h-[400px]'>
        ...
        <div className='col-span-2 flex flex-col gap-y-[30px]'>
          <img src={gridImage3} alt='patrons enjoying the gallery' className='min-h-[312px] min-w-[443px] relative left-[-17px]'/>
          <div className='flex flex-col text-[#ffffff] bg-[#151515] gap-y-[22px] min-h-[376px] pl-[50px] min-w-[443px] relative left-[-17px]'>
