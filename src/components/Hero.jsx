    ...
    <div className="flex w-[1439px]">
      <div className="w-[450px] bg-[#151515] flex flex-col">
        ...
        <div className="flex relative left-[164px] top-[274px]">
          ...
          <p className="text-[#151515] text-[96px] font-[900] cxHeading leading-none ml-[.5px]">LERY</p>
        </div>
      </div>
      ...
      <div className="w-[450px] flex flex-col h-full gap-[72px]">
        ...
        <div className="flex cursor-pointer gap-0 items-center text-[#ffffff] relative left-[-64px]" onMouseEnter={hoverOn} onMouseLeave={hoverOff}>
          <button className={`relative flex text-[#ffffff] text-[22px] tracking-[0.2em] border-none rounded-none px-8 cxHeading py-[.882em] w-[203px] text-nowrap font-[650] ${active ? 'bg-[#d5966c]' : 'bg-[#151515]'}`}>OUR LOCATION</button>
          <div className={`relative ml-0 px-3 py-[9.5px] w-[57px] flex justify-center ${active ? 'bg-[#151515]' : 'bg-[#d5966c]'}`}>
